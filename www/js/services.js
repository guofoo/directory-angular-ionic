...
return {
  ...
  findById: function(employeeId) {
    var deferred = $q.defer();
    //get employee through employeeId and resolve the employee


    return deferred.promise;
  },

  //Search epmployee by his/her full name. Search is case insensitive
  findByName: function(searchKey) {
    var deferred = $q.defer();
    //get search results based on employees' full name and resolve the results
  ...
  //search employees by the managerId attributes
  findByManager: function (managerId) {
    var deferred = $q.defer();
    //get search results based on employees' managerId and resolve the results
